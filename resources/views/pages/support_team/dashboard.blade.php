               ...
               <div class="card card-body bg-blue-400 has-bg-image">
                   <div class="media">
                       <div class="media-body">
                           ...
                           <span class="text-uppercase font-size-xs font-weight-bold">Total Trainees</span>
                       </div>
               ...
               <div class="card card-body bg-danger-400 has-bg-image">
                   <div class="media">
                       <div class="media-body">
                           ...
                           <span class="text-uppercase font-size-xs">Total Trainers</span>
                       </div>
               ...
               <div class="card card-body bg-indigo-400 has-bg-image">
                   <div class="media">
                       ...
                       <div class="media-body text-right">
                           ...
                           <span class="text-uppercase font-size-xs">Training Staff</span>
                       </div>
                   </div>
               </div>
           </div>
